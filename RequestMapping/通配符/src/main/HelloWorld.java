...
public class HelloWorld {
    ...
    public String expression(){
        System.out.println("- /user/*/get：匹配/user/v1/get");
        System.out.println("- /user/**/get：匹配/user/get、/user/v1/get、/user/v1/new/get");
        System.out.println("- /user/v?/get：匹配/user/v1/get、/user/v2/get");
        System.out.println("- /user/v??/get：匹配/user/v11/get、/user/v12/get");
        return "success";
    }
